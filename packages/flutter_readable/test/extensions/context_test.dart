            ...
            return FloatingActionButton(
              ...
              onPressed: () {
                final extensions = <String, bool Function(BuildContext)>{
                  ...
                  'scaffold': (ctx) =>
                      identical(ctx.scaffold, Scaffold.of(ctx)),
                  'scaffoldMaybeOf': (ctx) =>
                      identical(ctx.scaffoldMaybeOf, Scaffold.maybeOf(ctx)),
                  'scaffoldMessenger': (ctx) => identical(
                        ctx.scaffoldMessenger,
                  ...
                  'isLtr': (ctx) =>
                      ctx.isLtr ==
                      (Directionality.of(ctx) == TextDirection.ltr),
                  'locale': (ctx) =>
